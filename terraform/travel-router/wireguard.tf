...
# # Create VXLAN interface for bridging
# resource "routeros_interface_vxlan" "home" {
#   comment = "Managed by Terraform"
#   name    = "vxlan-home"
#   vni     = 10
#   # bridge = routeros_interface_bridge.bridge_lan
#   # bridge_vid = local.vlan_id_home
# }

# resource "routeros_interface_vxlan_vteps" "home" {
#   comment   = "Managed by Terraform"
#   interface = routeros_interface_vxlan.home.name
#   remote_ip = "10.17.100.1"
# }
