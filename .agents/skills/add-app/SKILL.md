...
| `kubernetes/apps/network/towonel-agent` | Custom probes |
| `kubernetes/apps/selfhosted/homepage` | Secrets, config file via configMapGenerator |
| `kubernetes/apps/ai/open-webui` | dragonfly dependency, kopiur-backed persistence |
